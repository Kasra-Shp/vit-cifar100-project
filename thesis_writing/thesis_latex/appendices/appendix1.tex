...
per-task accuracies after classifier rescaling; SimpleAvg has no
intermediate merged model and therefore no $R_{i,j}$ table. $R_{i,j}$ is the accuracy on task $j$ after
