...
Protocol depth is not a research question of this thesis. All experiments
use the single primary five-step protocol ($5\times20$,
Chapter~\ref{ch:experimental-setup}); alternative protocol depths were not
experimentally evaluated. Protocol depth therefore bounds how far the
results reported here can be generalised, and a controlled protocol-depth
study is identified as future work in Section~\ref{sec:ch6-future-work}.
