...
\section[Orthogonality-Based Regularization for Continual Learning]{Orthogonality-Based Regularization\\for Continual Learning}
...
The classifier rescaling applied in this thesis belongs to the Weight
Aligning family and is used only as a partial remedy discussed alongside the third
...
mode. This paired diagnostic is the distinctive element. The classifier
rescaling used in this thesis is related to Weight Aligning
\parencite{zhao2020maintaining} and is treated as a supporting
inference-time mechanism rather than as a contribution.
