...
is the primary benchmark: 100 object classes, 50,000 training
...
\textbf{CUB-200-2011} (Caltech-UCSD Birds-200-2011) \parencite{wah2011cub} provides a second-dataset
...
\textbf{Classifier rescaling.} The confidence-weighted, regime-grouped
row-norm rescaling mode of Section~\ref{sec:ch3-calibration} is applied,
...
the same rescaled classifier is used for both open and restricted
evaluation.
...
RankExt, a frozen copy of the model defined by the persistent adapter and
classifier state at the end of the previous step.
...
final model after classifier rescaling.
