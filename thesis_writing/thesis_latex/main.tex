...
% ---- Front matter order ----------------------------------------------------
% Title page / blank / Declaration of Originality / blank / Abstract / blank
% / Acknowledgements / Contents / List of Figures / List of Tables / Preface
% / Chapter 1. Each \blankpage (DEIthesis.cls) is a single page with no
% header, footer, or printed page number.
\frontmatter
\maketitle
\blankpage
