...
\coadvisor{Eng. Leon Marx}
% \coadvisor (DEIthesis.cls) renders a "Co-supervisor" entry directly below
% the Advisor on the title page; omit it to show the Advisor only.
...
% ---- Front matter order ----------------------------------------------------
% Title page / blank (physical page 2) / Abstract / Acknowledgements /
% Preface / Contents / List of Figures / List of Tables / Chapter 1. Each
% \blankpage (DEIthesis.cls) is a single page with no header, footer, or
% printed page number. The Declaration of Originality
% (frontmatter/declaration.tex) is intentionally not included for now; its
% wording is pending the author's decision.
\frontmatter
\maketitle
\blankpage
...
\chapter{Experimental Details and Supplementary Results}
\label{app:appendix1}
